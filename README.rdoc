Photo sharing app using rails and paperclip gem



-- FINISHED --Let's make an app that lets users upload their photos to share with the world.

-- FINISHED -- Start off by letting people create accounts, following along with the authentication Railscast.

-- FINISHED -- Then, let them upload photos.
